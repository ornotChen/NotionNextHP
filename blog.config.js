...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '21bc57a37a3f80b99d2fe49724ab99bf,blog:2a2c57a37a3f80cd8218d20c0f0a46e7',
  THEME: process.env.NEXT_PUBLIC_THEME || 'ornot,blog:hexo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ornot/moto', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '偶尔做音乐。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ornot.work', // 网站地址
